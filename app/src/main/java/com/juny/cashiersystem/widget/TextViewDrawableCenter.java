...
public class TextViewDrawableCenter extends android.support.v7.widget.AppCompatTextView {
    ...
    public TextViewDrawableCenter(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public TextViewDrawableCenter(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
