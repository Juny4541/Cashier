...
/**
 * <br> ClassName: PrintUtil
 * <br> Description:
 * <br> Author: 原文: https://github.com/heroxuetao/PrintUtils
 * <br> Date:  2018/4/30 17:15
 */
...
public class PrintUtils {
    ...
    private static OutputStream sOutputStream = null;
    ...
    public static void setOutputStream(OutputStream outputStream) {
        PrintUtils.sOutputStream = outputStream;
    }
    ...
    public static void printText(String text) {
        try {
            ...
            sOutputStream.write(data, 0, data.length);
            sOutputStream.flush();
        } catch (IOException e) {
