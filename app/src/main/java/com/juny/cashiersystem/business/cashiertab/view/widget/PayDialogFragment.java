...
public class PayDialogFragment extends DialogFragment {
     ...
     * 支付方式
     */
    public final static int PAY_TYPE_CASHIER = 1;
    public final static int PAY_TYPE_ZFB = 2;
    public final static int PAY_TYPE_WECHAT = 3;
    public final static int PAY_TYPE_CARD = 4;
     ...
     * 支付方式类型，默认现金
     */
    private int mPayType = PAY_TYPE_CASHIER;
